...
namespace HR.Persistence.Repositories
{
    public class LocationRepository : ILocationRepository
    {
        ...
        {
            string sql = "EXEC SP_LocationUpdate @LocationId = {0}, @LocationName = {1}, @LocationStatus = {2}, @UpdatedBy = {3}";
            await _context.Database.ExecuteSqlRawAsync(sql, dto.LocationId, dto.LocationName, dto.LocationStatus, dto.UpdatedBy);
